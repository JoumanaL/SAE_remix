import{r as t,j as n}from"./index-BJHAE5s4.js";import{n as s}from"./emotion-styled.browser.esm-BbCF7bfL.js";import{l as B,n as G,o as E,p as v,_ as N,L as h,M as q,q as U,O as u,S as Y}from"./components-N5w5wBNu.js";/**
 ...
 *
 * @license MIT
 */let p="positions";function z({getKey:e,...i}){let{isSpaMode:o}=B(),a=G(),l=E();v({getKey:e,storageKey:p});let j=t.useMemo(()=>{if(!e)return null;let r=e(a,l);return r!==a.key?r:null},[]);if(o)return null;let m=((r,f)=>{if(!window.history.state||!window.history.state.key){let c=Math.random().toString(32).slice(2);window.history.replaceState({key:c},"")}try{let x=JSON.parse(sessionStorage.getItem(r)||"{}")[f||window.history.state.key];typeof x=="number"&&window.scrollTo(0,x)}catch(c){console.error(c),sessionStorage.removeItem(r)}}).toString();return t.createElement("script",N({},i,{suppressHydrationWarning:!0,dangerouslySetInnerHTML:{__html:`(${m})(${JSON.stringify(p)}, ${JSON.stringify(j)})`}}))}function Q(e){return n.jsx("svg",{xmlns:"http://www.w3.org/2000/svg",width:23.335,height:23.335,...e,children:n.jsxs("g",{"data-name":"Group 99",fill:"#000",children:[n.jsx("path",{"data-name":"Rectangle 58",d:"M21.213 0l2.121 2.121L2.121 23.335 0 21.213z"}),n.jsx("path",{"data-name":"Rectangle 59",d:"M23.334 21.213l-2.121 2.121L-.001 2.121 2.121 0z"})]})})}function d(e){return n.jsx("svg",{version:"1.1",id:"Layer_1",xmlns:"http://www.w3.org/2000/svg",xmlnsXlink:"http://www.w3.org/1999/xlink",x:"0px",y:"0px",width:"32px",height:"42px",viewBox:"0 0 232 242",enableBackground:"new 0 0 232 242",xmlSpace:"preserve",...e,children:n.jsx("image",{id:"image0",width:"232",height:"242",x:"0",y:"0",xlinkHref:`data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAOgAAADyCAYAAABH5ImFAAAABGdBTUEAALGPC/xhBQAAACBjSFJN
...
`;function O(){const e=()=>new Date().getFullYear();return n.jsx(b,{children:n.jsx("div",{className:"darkBg",children:n.jsx("div",{className:"container",children:n.jsxs(k,{className:"flexSpaceCenter",style:{padding:"30px 0"},children:[n.jsxs(h,{className:"flexCenter animate pointer",to:"home",smooth:!0,offset:-80,children:[n.jsx(d,{}),n.jsx("h1",{className:"font15 extraBold ",style:{marginLeft:"15px"},children:"APIRP"})]}),n.jsxs(y,{className:" font13",children:["© ",e()," - ",n.jsx("span",{className:"darkRedColor font13",children:"Rosalie & Ornella"})," - No Right Reserved"]}),n.jsx(h,{className:" animate pointer font13",onClick:()=>window.scrollTo({top:0,behavior:"smooth"}),children:"Back to top"})]})})})})}const b=s.div`
  width: 100%;
`,k=s.div`
