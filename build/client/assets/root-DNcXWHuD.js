import{r as t,j as n}from"./index-BJHAE5s4.js";import{n as s}from"./emotion-styled.browser.esm-BbCF7bfL.js";import{l as B,n as G,o as E,p as v,_ as N,L as p,M as q,q as U,O as u,S as Y}from"./components-N5w5wBNu.js";/**
 ...
 *
 * @license MIT
 */let h="positions";function z({getKey:e,...i}){let{isSpaMode:o}=B(),a=G(),l=E();v({getKey:e,storageKey:h});let j=t.useMemo(()=>{if(!e)return null;let r=e(a,l);return r!==a.key?r:null},[]);if(o)return null;let m=((r,f)=>{if(!window.history.state||!window.history.state.key){let c=Math.random().toString(32).slice(2);window.history.replaceState({key:c},"")}try{let x=JSON.parse(sessionStorage.getItem(r)||"{}")[f||window.history.state.key];typeof x=="number"&&window.scrollTo(0,x)}catch(c){console.error(c),sessionStorage.removeItem(r)}}).toString();return t.createElement("script",N({},i,{suppressHydrationWarning:!0,dangerouslySetInnerHTML:{__html:`(${m})(${JSON.stringify(h)}, ${JSON.stringify(j)})`}}))}function Q(e){return n.jsx("svg",{xmlns:"http://www.w3.org/2000/svg",width:23.335,height:23.335,...e,children:n.jsxs("g",{"data-name":"Group 99",fill:"#000",children:[n.jsx("path",{"data-name":"Rectangle 58",d:"M21.213 0l2.121 2.121L2.121 23.335 0 21.213z"}),n.jsx("path",{"data-name":"Rectangle 59",d:"M23.334 21.213l-2.121 2.121L-.001 2.121 2.121 0z"})]})})}function d(e){return n.jsx("svg",{version:"1.1",id:"Layer_1",xmlns:"http://www.w3.org/2000/svg",xmlnsXlink:"http://www.w3.org/1999/xlink",x:"0px",y:"0px",width:"32px",height:"42px",viewBox:"0 0 232 242",enableBackground:"new 0 0 232 242",xmlSpace:"preserve",...e,children:n.jsx("image",{id:"image0",width:"232",height:"242",x:"0",y:"0",xlinkHref:`data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAOgAAADyCAYAAABH5ImFAAAABGdBTUEAALGPC/xhBQAAACBjSFJN
        ...
        eQAyMDI0LTA0LTEzVDEyOjUxOjI3KzAyOjAwKCtdJAAAAABJRU5ErkJggg==`})})}function R({sidebarOpen:e,toggleSidebar:i}){return n.jsxs(g,{role:"navigation",className:"animate darkBg",isOpen:e,children:[n.jsxs(A,{className:"flexSpaceCenter",children:[n.jsx("div",{className:"flexNullCenter",children:n.jsx(d,{})}),n.jsx(M,{onClick:()=>i(!e),className:"animate pointer",children:n.jsx(Q,{})})]}),n.jsxs(V,{className:"flexNullCenter flexColumn",children:[n.jsx("li",{className:"semiBold font15 pointer",children:n.jsx("a",{href:"/accueil",onClick:()=>i(!e),style:{padding:"10px 15px"},children:"Accueil"})}),n.jsx("li",{className:"semiBold font15 pointer",children:n.jsx("a",{href:"/forum",onClick:()=>i(!e),style:{padding:"10px 15px"},children:"Forum"})}),n.jsx("li",{className:"semiBold font15 pointer",children:n.jsx("a",{href:"/Activites",onClick:()=>i(!e),style:{padding:"10px 15px"},children:"Activités"})}),n.jsx("li",{className:"semiBold font15 pointer",children:n.jsx("a",{href:"/contact",onClick:()=>i(!e),style:{padding:"10px 15px"},children:"Nous connaître"})}),n.jsx("li",{className:"semiBold font15 pointer",children:n.jsx("a",{href:"/adherer",onClick:()=>i(!e),style:{padding:"10px 15px"},children:"Adhérer"})}),n.jsx("li",{className:"semiBold font15 pointer",children:n.jsx("a",{href:"/promouvoir",onClick:()=>i(!e),style:{padding:"10px 15px"},children:"Promouvoir"})}),n.jsx("li",{className:"semiBold font15 pointer",children:n.jsx("a",{href:"/apprendre",onClick:()=>i(!e),style:{padding:"10px 15px"},children:"Apprendre"})}),n.jsx("li",{className:"semiBold font15 pointer",children:n.jsx("a",{href:"/enseigner",onClick:()=>i(!e),style:{padding:"10px 15px"},children:"Enseigner"})}),n.jsx("li",{className:"semiBold font15 pointer",children:n.jsx("a",{href:"/divers",onClick:()=>i(!e),style:{padding:"10px 15px"},children:"Divers"})})]})]})}const g=s.div`
  width: 400px;
  height: 100vh;
  position: fixed;
  top: 0;
  padding: 0 30px;
right: ${e=>e.isOpen?"0px":"-400px"};
  z-index: 9999;
...
`;function W({toggleSidebar:e}){return n.jsx(S,{className:"darkBg",onClick:()=>e(!1)})}const S=s.div`
  width: 100%;
  height: 100vh;
  position: fixed;
  top: 0;
  ...
  z-index: 99;
  opacity: 0.8;
`;function I(e){return n.jsxs("svg",{xmlns:"http://www.w3.org/2000/svg",width:28,height:22,viewBox:"0 0 28 22",...e,children:[n.jsx("path",{"data-name":"Line 5",fill:"none",stroke:"#0b093b",strokeLinecap:"round",strokeWidth:2,d:"M1 1h26"}),n.jsx("path",{"data-name":"Line 6",fill:"none",stroke:"#0b093b",strokeLinecap:"round",strokeWidth:2,d:"M1 11h26"}),n.jsx("path",{"data-name":"Line 7",fill:"none",stroke:"#0b093b",strokeLinecap:"round",strokeWidth:2,d:"M1 21h26"})]})}function T(){const[e,i]=t.useState(0),[o,a]=t.useState(!1);return t.useEffect(()=>{if(typeof window<"u"){const l=()=>i(window.scrollY);return window.addEventListener("scroll",l),()=>window.removeEventListener("scroll",l)}},[]),n.jsxs(n.Fragment,{children:[n.jsx(R,{sidebarOpen:o,toggleSidebar:a}),o&&n.jsx(W,{toggleSidebar:a}),n.jsx(C,{className:"flexCenter animate whiteBg",style:e>100?{height:"60px"}:{height:"80px"},children:n.jsxs(F,{className:"container flexSpaceCenter",children:[n.jsx("a",{href:"/accueil",className:"pointer flexNullCenter",children:n.jsx(d,{})}),n.jsx(Z,{className:"pointer",onClick:()=>a(!o),children:n.jsx(I,{})}),n.jsxs(J,{className:"flexNullCenter",children:[n.jsx("li",{className:"semiBold font15 pointer",children:n.jsx("a",{href:"/accueil",style:{padding:"10px 15px"},children:"Accueil"})}),n.jsx("li",{className:"semiBold font15 pointer",children:n.jsx("a",{href:"/Forum",style:{padding:"10px 15px"},children:"Forum"})}),n.jsx("li",{className:"semiBold font15 pointer",children:n.jsx("a",{href:"/Activites",style:{padding:"10px 15px"},children:"Activités"})}),n.jsx("li",{className:"semiBold font15 pointer",children:n.jsx("a",{href:"/Contact",style:{padding:"10px 15px"},children:"Nous connaître"})}),n.jsx("li",{className:"semiBold font15 pointer",children:n.jsx("a",{href:"/adherer",style:{padding:"10px 15px"},children:"Adhérer"})}),n.jsx("li",{className:"semiBold font15 pointer",children:n.jsx("a",{href:"/Promouvoir",style:{padding:"10px 15px"},children:"Promouvoir"})}),n.jsx("li",{className:"semiBold font15 pointer",children:n.jsx("a",{href:"/apprendre",style:{padding:"10px 15px"},children:"Apprendre"})}),n.jsx("li",{className:"semiBold font15 pointer",children:n.jsx("a",{href:"/enseigner",style:{padding:"10px 15px"},children:"Enseigner"})}),n.jsx("li",{className:"semiBold font15 pointer",children:n.jsx("a",{href:"/divers",style:{padding:"10px 15px"},children:"Divers"})})]})]})})]})}const C=s.nav`
  width: 100%;
  position: fixed;
  top: 0;
  left: 0;
...
`;function O(){const e=()=>new Date().getFullYear();return n.jsx(b,{children:n.jsx("div",{className:"darkBg",children:n.jsx("div",{className:"container",children:n.jsxs(k,{className:"flexSpaceCenter",style:{padding:"30px 0"},children:[n.jsxs(p,{className:"flexCenter animate pointer",to:"Accueil",smooth:!0,offset:-80,children:[n.jsx(d,{}),n.jsx("h1",{className:"font15 extraBold ",style:{marginLeft:"15px"},children:"APIRP"})]}),n.jsxs(y,{className:" font13",children:["© ",e()," - ",n.jsx("span",{className:"darkRedColor font13",children:"Rosalie & Ornella"})," - No Right Reserved"]}),n.jsx(p,{className:" animate pointer font13",onClick:()=>window.scrollTo({top:0,behavior:"smooth"}),children:"Back to top"})]})})})})}const b=s.div`
  width: 100%;
`,k=s.div`
